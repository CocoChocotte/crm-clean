...
{
    public partial class UpdateClientCommand : IRequest
    {
    ...
    public class UpdateClientCommandHandler : IRequestHandler<UpdateClientCommand>
    {
        ...
        public UpdateClientCommandHandler(IApplicationDbContext context, ICurrentUserService currentUser, IIdentityService identityService)
        {
            _context = context;
